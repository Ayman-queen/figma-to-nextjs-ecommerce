...
function Filter() {
    return (
        <div className='box-border hidden md:flex flex-col items-start px-[24px] py-[20px] gap-[24px] w-[295px] min-h-[1220px] border-[1px] border-[rgba(0,0,0,0.1)] rounded-[20px]'>
            ...
            <div className='flex flex-col items-start p-0 gap-[20px] w-[247px] h-[274px]'>
                ...
                <div className="flex flex-row flex-wrap items-start content-start p-0 gap-[8px] w-[247px] h-[227px] group">
  <button className="peer px-[20px] py-[10px] rounded-full bg-[#F0F0F0] text-[14px] text-black/60 hover:bg-black hover:text-white group-hover:opacity-50 hover:opacity-100">
    XX-Small
  </button>
  <button className="peer px-[20px] py-[10px] rounded-full bg-[#F0F0F0] text-[14px] text-black/60 hover:bg-black hover:text-white group-hover:opacity-50 hover:opacity-100">
    X-Small
  ...
  <button className="px-[20px] py-[10px] rounded-full bg-[#111111] text-[14px] text-white group-hover:opacity-100">
    Large
  </button>
  <button className="peer px-[20px] py-[10px] rounded-full bg-[#F0F0F0] text-[14px] text-black/60 hover:bg-black hover:text-white group-hover:opacity-50 hover:opacity-100">
    X-Large

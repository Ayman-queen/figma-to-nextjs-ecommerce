...
function page() {
            ...
            <div className='flex flex-col lg:flex-row items-center justify-center px-[16px] gap-[12px] md:gap-[14px] mt-[20px] md:mt-[36px]'>
                <div className='flex flex-col-reverse lg:flex-row gap-[12px] md:gap-[14px]'>
                    <div className='flex flex-row lg:flex-col items-center justify-center gap-[12px] md:gap-[14px]'>
                        <Image src={"/Productdetail/img E.png"} alt='One Life Graphic T-shirt' width={170} height={138} className='w-[111px] lg:w-[152px] h-[106px] lg:h-[167px]' />
                        <Image src={"/Productdetail/img F.png"} alt='One Life Graphic T-shirt' width={170} height={138} className='w-[111px] lg:w-[152px] h-[106px] lg:h-[167px]' />
                        <Image src={"/Productdetail/img G.png"} alt='One Life Graphic T-shirt' width={170} height={138} className='w-[111px] lg:w-[152px] h-[106px] lg:h-[167px]' />
                    </div>
                    <Image src={"/Productdetail/img H.png"} alt='One Life Graphic T-shirt' width={500} height={600} className='w-full md:w-[444px] h-[290px] md:h-[530px]' />
    ...
    <Button className='px-[20px] md:px-[24px] h-[39px] md:h-[46px] text-[14px] md:text-[16px] rounded-full bg-[#F0F0F0] text-black/60 hover:bg-lightblue-500 hover:text-white'>
        Small
    </Button>
    <Button className='px-[20px] md:px-[24px] h-[39px] md:h-[46px] text-[14px] md:text-[16px] rounded-full bg-[#F0F0F0] text-black/60 hover:bg-lightblue-500 hover:text-white'>
        Medium
    </Button>
    <Button className='px-[20px] md:px-[24px] h-[39px] md:h-[46px] text-[14px] md:text-[16px] rounded-full text-white bg-blue-600 border border-gray-500'>
        Large
    </Button>
    <Button className='px-[20px] md:px-[24px] h-[39px] md:h-[46px] text-[14px] md:text-[16px] rounded-full bg-[#F0F0F0] text-black/60 hover:bg-lightblue-500 hover:text-white'>
        X-Large
                        ...
                        <div className='flex flex-wrap gap-[12px] md:gap-[16px]'>
                            ...
                            <Button className='w-[236px] md:w-[400px] h-[44px] rounded-full text-[14px] md:text-[16px] bg-blue-600 text-white'>
                                 Add to Cart
                                 </Button>
